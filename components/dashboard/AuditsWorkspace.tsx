...
export default function AuditsWorkspace() {
  return (
    <EspaceDeTravail
      ...
      libelleAction="Planifier un audit"
      titreModale="Planifier un audit"
      formulaire={(fait) => <AuditForm dansModale onEnregistre={fait} />}
      liste={(cle) => <QualitySection registre="audit" cleRafraichissement={cle} />}
    />
  );
}
