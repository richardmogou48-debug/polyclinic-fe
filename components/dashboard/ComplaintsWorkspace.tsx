...
export default function ComplaintsWorkspace() {
  return (
    <EspaceDeTravail
      titre="Réclamations"
      libelleAction="Enregistrer une réclamation"
      titreModale="Enregistrer une réclamation"
      formulaire={(fait) => <ComplaintForm dansModale onDeclare={fait} />}
      liste={(cle) => <QualitySection registre="complaint" cleRafraichissement={cle} />}
    />
  );
}
